...
- __Application__ refers to Broulf Asset Management, the software program provided by the Company.

- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Broulf Asset Management.
...
- __Website__ refers to Broulf Asset Management, accessible from [https://inventory.broulf.org](https://inventory.broulf.org)
